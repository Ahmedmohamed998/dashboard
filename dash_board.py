...
with col1:
    ...
    with st.expander("Insights"):
        st.write("""- Approximately 56.4% of the customers are male.""")
...
with col2:
    ...
    st.plotly_chart(fig)
    with st.expander("Insights"):
        st.write("""- The average age of customers is around 38.13 years.""")
...
with col2:
    ...
    st.plotly_chart(fig)
    with st.expander("Insights"):
        st.write("""- A significant proportion (around 75.4%) of customers have a credit card (HasCrCard).""")
...
with col3:
    ...
    st.plotly_chart(fig)
    with st.expander("Insights"):
        st.write("""- The average credit score is approximately 656.45. - The minimum credit score is 350, and the maximum is 850.""")
...
with col1:
    ...
    st.plotly_chart(fig)
    with st.expander("Insights"):
        st.write("""- About 12.7% of customers have exited the bank (Exited = 1). - The majority (about 87.3%) have not exited the bank (Exited = 0).""")
...
with col2:
    ...
    st.plotly_chart(fig)
    with st.expander("Insights"):
        st.write("""- The year 2022 saw the highest number of customers, totaling 30.331k. - Conversely, 2024 had the lowest number of customers, with only 8431. - On average, we attract around 27.500k customers each year.""")
...
with col3:
    ...
    st.plotly_chart(fig)
    with st.expander("Insights"):
        st.write("""- Approximately 50.3% of customers are active members (IsActiveMember).""")
